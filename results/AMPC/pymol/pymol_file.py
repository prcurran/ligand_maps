...
acceptor_projected_point_0 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(25.0), float(6.5), float(13.0), float(1)]

cmd.load_cgo(acceptor_projected_point_0, "acceptor_projected_point_0_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_0_score", pos=(25.0, 6.5, 13.0), color=(1, 1, 1), label=21.0)
...
acceptor_projected_point_3 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(19.5), float(3.5), float(9.5), float(1)]

cmd.load_cgo(acceptor_projected_point_3, "acceptor_projected_point_3_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_3_score", pos=(19.5, 3.5, 9.5), color=(1, 1, 1), label=17.6)

cmd.pseudoatom(object="acceptor_projected_point_3_proj_score", pos=(18.75, 3.5, 13.25), color=(1, 1, 1), label=10.2)

acceptor_projected_projection_3 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 0.8] + [SPHERE, float(18.75), float(3.5), float(13.25), float(1)]

cmd.load_cgo(acceptor_projected_projection_3, "acceptor_projected_projection_3_obj", 1)
cmd.pseudoatom(object="acceptor_projected_line_3pa1", pos=(19.5, 3.5, 9.5), color=(1, 1, 1))

cmd.pseudoatom(object="acceptor_projected_line_3pa2", pos=(18.75, 3.5, 13.25), color=(1, 1, 1))
...
acceptor_projected_point_4 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(19.5), float(3.5), float(9.5), float(1)]

cmd.load_cgo(acceptor_projected_point_4, "acceptor_projected_point_4_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_4_score", pos=(19.5, 3.5, 9.5), color=(1, 1, 1), label=17.6)

cmd.pseudoatom(object="acceptor_projected_point_4_proj_score", pos=(16.75, 1.75, 9.5), color=(1, 1, 1), label=10.7)

acceptor_projected_projection_4 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 0.8] + [SPHERE, float(16.75), float(1.75), float(9.5), float(1)]

cmd.load_cgo(acceptor_projected_projection_4, "acceptor_projected_projection_4_obj", 1)
cmd.pseudoatom(object="acceptor_projected_line_4pa1", pos=(19.5, 3.5, 9.5), color=(1, 1, 1))

cmd.pseudoatom(object="acceptor_projected_line_4pa2", pos=(16.75, 1.75, 9.5), color=(1, 1, 1))
...
acceptor_projected_point_5 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(25.0), float(4.5), float(17.0), float(1)]

cmd.load_cgo(acceptor_projected_point_5, "acceptor_projected_point_5_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_5_score", pos=(25.0, 4.5, 17.0), color=(1, 1, 1), label=16.9)

cmd.pseudoatom(object="acceptor_projected_point_5_proj_score", pos=(25.75, 1.75, 18.0), color=(1, 1, 1), label=11.1)

acceptor_projected_projection_5 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 0.8] + [SPHERE, float(25.75), float(1.75), float(18.0), float(1)]

cmd.load_cgo(acceptor_projected_projection_5, "acceptor_projected_projection_5_obj", 1)
cmd.pseudoatom(object="acceptor_projected_line_5pa1", pos=(25.0, 4.5, 17.0), color=(1, 1, 1))

cmd.pseudoatom(object="acceptor_projected_line_5pa2", pos=(25.75, 1.75, 18.0), color=(1, 1, 1))
...
surface_list = {None: {'feature_grids': ['surface_ring', 'surface_donor_projected', 'surface_acceptor_projected']}}
surface_max_list = {None: {'feature_grids': 21.0}}
