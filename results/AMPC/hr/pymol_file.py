...
cmd.pseudoatom(object="PS_apolar_hotspot_0", pos=(25.0, 7.5, 16.5), color=(1, 1, 1), label=11.5)

cmd.pseudoatom(object="PS_apolar_hotspot_1", pos=(25.0, 6.5, 14.0), color=(1, 1, 1), label=10.0)

cmd.pseudoatom(object="PS_apolar_hotspot_2", pos=(22.0, 5.5, 11.5), color=(1, 1, 1), label=18.1)
...
cmd.group("label_apolar_hotspot", members="PS_apolar_hotspot_2")
cmd.pseudoatom(object="PS_donor_hotspot_0", pos=(24.5, 6.0, 14.5), color=(1, 1, 1), label=20.5)

cmd.pseudoatom(object="PS_donor_hotspot_1", pos=(19.5, 4.0, 9.0), color=(1, 1, 1), label=6.3)

cmd.group("label_donor_hotspot", members="PS_donor_hotspot_0")
cmd.group("label_donor_hotspot", members="PS_donor_hotspot_0")
cmd.group("label_donor_hotspot", members="PS_donor_hotspot_1")
cmd.group("label_donor_hotspot", members="PS_donor_hotspot_1")
cmd.pseudoatom(object="PS_acceptor_hotspot_0", pos=(25.0, 6.5, 13.0), color=(1, 1, 1), label=21.0)

cmd.pseudoatom(object="PS_acceptor_hotspot_1", pos=(25.0, 4.5, 17.0), color=(1, 1, 1), label=16.9)

cmd.pseudoatom(object="PS_acceptor_hotspot_2", pos=(21.0, 5.5, 12.5), color=(1, 1, 1), label=7.2)

cmd.pseudoatom(object="PS_acceptor_hotspot_3", pos=(19.5, 3.5, 9.5), color=(1, 1, 1), label=17.6)
...
surface_max_list = {'hotspot': {'fhm': 21.0}}
