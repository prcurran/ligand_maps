...
cmd.pseudoatom(object="PS_apolar_hotspot_0", pos=(31.0, 8.5, 65.5), color=(1, 1, 1), label=115.1)

cmd.pseudoatom(object="PS_apolar_hotspot_1", pos=(27.5, 5.0, 64.5), color=(1, 1, 1), label=191.4)

cmd.pseudoatom(object="PS_apolar_hotspot_2", pos=(25.0, 7.0, 61.5), color=(1, 1, 1), label=62.2)
...
cmd.group("label_apolar_hotspot", members="PS_apolar_hotspot_2")
cmd.pseudoatom(object="PS_donor_hotspot_0", pos=(32.5, 12.0, 64.0), color=(1, 1, 1), label=38.3)

cmd.pseudoatom(object="PS_donor_hotspot_1", pos=(31.5, 11.5, 68.0), color=(1, 1, 1), label=6.9)

cmd.pseudoatom(object="PS_donor_hotspot_2", pos=(30.0, 6.5, 65.5), color=(1, 1, 1), label=137.3)

cmd.pseudoatom(object="PS_donor_hotspot_3", pos=(27.0, 9.0, 62.5), color=(1, 1, 1), label=14.9)

cmd.pseudoatom(object="PS_donor_hotspot_4", pos=(27.0, 3.0, 64.5), color=(1, 1, 1), label=102.9)

cmd.pseudoatom(object="PS_donor_hotspot_5", pos=(25.0, 8.5, 60.0), color=(1, 1, 1), label=18.7)
...
cmd.group("label_donor_hotspot", members="PS_donor_hotspot_5")
cmd.pseudoatom(object="PS_acceptor_hotspot_0", pos=(34.5, 10.5, 64.0), color=(1, 1, 1), label=46.0)

cmd.pseudoatom(object="PS_acceptor_hotspot_1", pos=(28.5, 4.5, 65.5), color=(1, 1, 1), label=190.6)

cmd.pseudoatom(object="PS_acceptor_hotspot_2", pos=(25.0, 4.0, 63.0), color=(1, 1, 1), label=49.1)

cmd.pseudoatom(object="PS_acceptor_hotspot_3", pos=(24.0, 7.0, 61.0), color=(1, 1, 1), label=37.1)
...
surface_max_list = {'hotspot': {'fhm': 191.4}}
