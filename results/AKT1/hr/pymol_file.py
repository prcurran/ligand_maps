...
cmd.pseudoatom(object="PS_apolar_hotspot_0", pos=(8.0, 3.5, 18.0), color=(1, 1, 1), label=7.5)

cmd.pseudoatom(object="PS_apolar_hotspot_1", pos=(4.5, 4.0, 16.0), color=(1, 1, 1), label=9.7)

cmd.group("label_apolar_hotspot", members="PS_apolar_hotspot_0")
cmd.group("label_apolar_hotspot", members="PS_apolar_hotspot_0")
cmd.group("label_apolar_hotspot", members="PS_apolar_hotspot_1")
cmd.group("label_apolar_hotspot", members="PS_apolar_hotspot_1")
cmd.pseudoatom(object="PS_donor_hotspot_0", pos=(2.5, 3.0, 15.5), color=(1, 1, 1), label=6.5)

cmd.group("label_donor_hotspot", members="PS_donor_hotspot_0")
cmd.group("label_donor_hotspot", members="PS_donor_hotspot_0")
cmd.pseudoatom(object="PS_acceptor_hotspot_0", pos=(3.5, 5.0, 15.5), color=(1, 1, 1), label=9.5)
...
surface_max_list = {'hotspot': {'fhm': 9.7}}
