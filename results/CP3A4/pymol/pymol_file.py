...
acceptor_projected_point_0 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(18.0), float(25.5), float(9.5), float(1)]

cmd.load_cgo(acceptor_projected_point_0, "acceptor_projected_point_0_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_0_score", pos=(18.0, 25.5, 9.5), color=(1, 1, 1), label=7.3)

cmd.pseudoatom(object="acceptor_projected_point_0_proj_score", pos=(19.5, 25.25, 11.5), color=(1, 1, 1), label=5.8)

acceptor_projected_projection_0 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 0.8] + [SPHERE, float(19.5), float(25.25), float(11.5), float(1)]

cmd.load_cgo(acceptor_projected_projection_0, "acceptor_projected_projection_0_obj", 1)
cmd.pseudoatom(object="acceptor_projected_line_0pa1", pos=(18.0, 25.5, 9.5), color=(1, 1, 1))

cmd.pseudoatom(object="acceptor_projected_line_0pa2", pos=(19.5, 25.25, 11.5), color=(1, 1, 1))
...
donor_projected_point_1 = [COLOR, 0.0, 0.0, 1.0] +  [ALPHA, 0.8] + [SPHERE, float(16.5), float(27.0), float(10.5), float(1)]

cmd.load_cgo(donor_projected_point_1, "donor_projected_point_1_obj", 1)
cmd.pseudoatom(object="donor_projected_point_1_score", pos=(16.5, 27.0, 10.5), color=(1, 1, 1), label=6.9)

cmd.pseudoatom(object="donor_projected_point_1_proj_score", pos=(18.5, 26.0, 12.5), color=(1, 1, 1), label=4.9)

donor_projected_projection_1 = [COLOR, 0.6, 0.6, 1.0] +  [ALPHA, 0.8] + [SPHERE, float(18.5), float(26.0), float(12.5), float(1)]

cmd.load_cgo(donor_projected_projection_1, "donor_projected_projection_1_obj", 1)
cmd.pseudoatom(object="donor_projected_line_1pa1", pos=(16.5, 27.0, 10.5), color=(1, 1, 1))

cmd.pseudoatom(object="donor_projected_line_1pa2", pos=(18.5, 26.0, 12.5), color=(1, 1, 1))
...
ring_point_2 = [COLOR, 0.33, 1.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(15.0), float(28.5), float(11.0), float(2.0)]

cmd.load_cgo(ring_point_2, "ring_point_2_obj", 1)
cmd.pseudoatom(object="ring_point_2_score", pos=(15.0, 28.5, 11.0), color=(1, 1, 1), label=6.5)

cmd.group("ring_2", members="ring_point_2_obj")
cmd.group("ring_2", members="ring_point_2_score")
ring_point_3 = [COLOR, 0.33, 1.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(17.0), float(25.5), float(8.0), float(2.0)]

cmd.load_cgo(ring_point_3, "ring_point_3_obj", 1)
cmd.pseudoatom(object="ring_point_3_score", pos=(17.0, 25.5, 8.0), color=(1, 1, 1), label=5.5)

cmd.group("ring_3", members="ring_point_3_obj")
cmd.group("ring_3", members="ring_point_3_score")
acceptor_projected_point_4 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(14.5), float(26.0), float(4.0), float(1)]

cmd.load_cgo(acceptor_projected_point_4, "acceptor_projected_point_4_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_4_score", pos=(14.5, 26.0, 4.0), color=(1, 1, 1), label=4.7)

cmd.pseudoatom(object="acceptor_projected_point_4_proj_score", pos=(14.25, 25.5, 1.25), color=(1, 1, 1), label=3.3)

acceptor_projected_projection_4 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 0.8] + [SPHERE, float(14.25), float(25.5), float(1.25), float(1)]

cmd.load_cgo(acceptor_projected_projection_4, "acceptor_projected_projection_4_obj", 1)
cmd.pseudoatom(object="acceptor_projected_line_4pa1", pos=(14.5, 26.0, 4.0), color=(1, 1, 1))

cmd.pseudoatom(object="acceptor_projected_line_4pa2", pos=(14.25, 25.5, 1.25), color=(1, 1, 1))
...
ring_point_5 = [COLOR, 0.33, 1.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(15.0), float(26.5), float(5.0), float(2.0)]

cmd.load_cgo(ring_point_5, "ring_point_5_obj", 1)
cmd.pseudoatom(object="ring_point_5_score", pos=(15.0, 26.5, 5.0), color=(1, 1, 1), label=4.3)
...
surface_max_list = {None: {'feature_grids': 7.3}}
