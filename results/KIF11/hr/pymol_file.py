...
cmd.pseudoatom(object="PS_apolar_hotspot_0", pos=(21.0, 15.0, 107.0), color=(1, 1, 1), label=13.9)

cmd.pseudoatom(object="PS_apolar_hotspot_1", pos=(18.5, 15.0, 109.0), color=(1, 1, 1), label=14.0)

cmd.pseudoatom(object="PS_apolar_hotspot_2", pos=(18.0, 13.0, 112.5), color=(1, 1, 1), label=21.6)
...
cmd.group("label_apolar_hotspot", members="PS_apolar_hotspot_2")
cmd.pseudoatom(object="PS_donor_hotspot_0", pos=(19.5, 13.5, 109.0), color=(1, 1, 1), label=6.7)

cmd.pseudoatom(object="PS_donor_hotspot_1", pos=(16.0, 13.0, 105.5), color=(1, 1, 1), label=7.5)

cmd.pseudoatom(object="PS_donor_hotspot_2", pos=(16.0, 11.5, 113.5), color=(1, 1, 1), label=7.9)
...
cmd.group("label_donor_hotspot", members="PS_donor_hotspot_2")
cmd.pseudoatom(object="PS_acceptor_hotspot_0", pos=(15.5, 15.0, 110.0), color=(1, 1, 1), label=6.7)
...
surface_max_list = {'hotspot': {'fhm': 21.6}}
