...
cmd.pseudoatom(object="PS_apolar_hotspot_0", pos=(42.0, 27.5, 10.5), color=(1, 1, 1), label=5.4)

cmd.pseudoatom(object="PS_apolar_hotspot_1", pos=(38.5, 32.0, 8.0), color=(1, 1, 1), label=12.2)

cmd.pseudoatom(object="PS_apolar_hotspot_2", pos=(37.5, 35.5, 5.5), color=(1, 1, 1), label=5.8)
...
cmd.group("label_apolar_hotspot", members="PS_apolar_hotspot_2")
cmd.pseudoatom(object="PS_donor_hotspot_0", pos=(38.0, 28.5, 11.0), color=(1, 1, 1), label=5.9)

cmd.group("label_donor_hotspot", members="PS_donor_hotspot_0")
cmd.group("label_donor_hotspot", members="PS_donor_hotspot_0")
cmd.pseudoatom(object="PS_acceptor_hotspot_0", pos=(42.0, 25.0, 12.0), color=(1, 1, 1), label=5.7)

cmd.pseudoatom(object="PS_acceptor_hotspot_1", pos=(38.0, 28.5, 11.0), color=(1, 1, 1), label=5.9)

cmd.pseudoatom(object="PS_acceptor_hotspot_2", pos=(37.5, 34.5, 8.0), color=(1, 1, 1), label=7.6)
...
surface_max_list = {'hotspot': {'fhm': 12.2}}
