...
ring_point_0 = [COLOR, 0.33, 1.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(38.5), float(32.0), float(8.0), float(2.0)]

cmd.load_cgo(ring_point_0, "ring_point_0_obj", 1)
cmd.pseudoatom(object="ring_point_0_score", pos=(38.5, 32.0, 8.0), color=(1, 1, 1), label=12.2)

cmd.group("ring_0", members="ring_point_0_obj")
cmd.group("ring_0", members="ring_point_0_score")
acceptor_projected_point_1 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(37.5), float(34.5), float(8.0), float(1)]

cmd.load_cgo(acceptor_projected_point_1, "acceptor_projected_point_1_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_1_score", pos=(37.5, 34.5, 8.0), color=(1, 1, 1), label=7.6)

cmd.pseudoatom(object="acceptor_projected_point_1_proj_score", pos=(39.75, 35.25, 5.0), color=(1, 1, 1), label=4.5)

acceptor_projected_projection_1 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 0.8] + [SPHERE, float(39.75), float(35.25), float(5.0), float(1)]

cmd.load_cgo(acceptor_projected_projection_1, "acceptor_projected_projection_1_obj", 1)
cmd.pseudoatom(object="acceptor_projected_line_1pa1", pos=(37.5, 34.5, 8.0), color=(1, 1, 1))

cmd.pseudoatom(object="acceptor_projected_line_1pa2", pos=(39.75, 35.25, 5.0), color=(1, 1, 1))
...
acceptor_projected_point_2 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 0.8] + [SPHERE, float(37.5), float(34.5), float(8.0), float(1)]

cmd.load_cgo(acceptor_projected_point_2, "acceptor_projected_point_2_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_2_score", pos=(37.5, 34.5, 8.0), color=(1, 1, 1), label=7.6)

cmd.pseudoatom(object="acceptor_projected_point_2_proj_score", pos=(36.0, 36.25, 9.0), color=(1, 1, 1), label=7.8)

acceptor_projected_projection_2 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 0.8] + [SPHERE, float(36.0), float(36.25), float(9.0), float(1)]

cmd.load_cgo(acceptor_projected_projection_2, "acceptor_projected_projection_2_obj", 1)
cmd.pseudoatom(object="acceptor_projected_line_2pa1", pos=(37.5, 34.5, 8.0), color=(1, 1, 1))

cmd.pseudoatom(object="acceptor_projected_line_2pa2", pos=(36.0, 36.25, 9.0), color=(1, 1, 1))
...
donor_projected_point_3 = [COLOR, 0.0, 0.0, 1.0] +  [ALPHA, 0.8] + [SPHERE, float(38.0), float(28.5), float(11.0), float(1)]

cmd.load_cgo(donor_projected_point_3, "donor_projected_point_3_obj", 1)
cmd.pseudoatom(object="donor_projected_point_3_score", pos=(38.0, 28.5, 11.0), color=(1, 1, 1), label=5.9)

cmd.pseudoatom(object="donor_projected_point_3_proj_score", pos=(38.5, 26.0, 9.5), color=(1, 1, 1), label=5.0)

donor_projected_projection_3 = [COLOR, 0.6, 0.6, 1.0] +  [ALPHA, 0.8] + [SPHERE, float(38.5), float(26.0), float(9.5), float(1)]

cmd.load_cgo(donor_projected_projection_3, "donor_projected_projection_3_obj", 1)
cmd.pseudoatom(object="donor_projected_line_3pa1", pos=(38.0, 28.5, 11.0), color=(1, 1, 1))

cmd.pseudoatom(object="donor_projected_line_3pa2", pos=(38.5, 26.0, 9.5), color=(1, 1, 1))
...
donor_projected_point_4 = [COLOR, 0.0, 0.0, 1.0] +  [ALPHA, 0.8] + [SPHERE, float(38.0), float(28.5), float(11.0), float(1)]

cmd.load_cgo(donor_projected_point_4, "donor_projected_point_4_obj", 1)
cmd.pseudoatom(object="donor_projected_point_4_score", pos=(38.0, 28.5, 11.0), color=(1, 1, 1), label=5.9)

cmd.pseudoatom(object="donor_projected_point_4_proj_score", pos=(37.0, 28.0, 13.5), color=(1, 1, 1), label=7.1)

donor_projected_projection_4 = [COLOR, 0.6, 0.6, 1.0] +  [ALPHA, 0.8] + [SPHERE, float(37.0), float(28.0), float(13.5), float(1)]

cmd.load_cgo(donor_projected_projection_4, "donor_projected_projection_4_obj", 1)
cmd.pseudoatom(object="donor_projected_line_4pa1", pos=(38.0, 28.5, 11.0), color=(1, 1, 1))

cmd.pseudoatom(object="donor_projected_line_4pa2", pos=(37.0, 28.0, 13.5), color=(1, 1, 1))
...
donor_projected_point_5 = [COLOR, 0.0, 0.0, 1.0] +  [ALPHA, 0.8] + [SPHERE, float(38.0), float(28.5), float(11.0), float(1)]

cmd.load_cgo(donor_projected_point_5, "donor_projected_point_5_obj", 1)
cmd.pseudoatom(object="donor_projected_point_5_score", pos=(38.0, 28.5, 11.0), color=(1, 1, 1), label=5.9)

cmd.pseudoatom(object="donor_projected_point_5_proj_score", pos=(36.0, 29.75, 9.25), color=(1, 1, 1), label=5.4)

donor_projected_projection_5 = [COLOR, 0.6, 0.6, 1.0] +  [ALPHA, 0.8] + [SPHERE, float(36.0), float(29.75), float(9.25), float(1)]

cmd.load_cgo(donor_projected_projection_5, "donor_projected_projection_5_obj", 1)
cmd.pseudoatom(object="donor_projected_line_5pa1", pos=(38.0, 28.5, 11.0), color=(1, 1, 1))

cmd.pseudoatom(object="donor_projected_line_5pa2", pos=(36.0, 29.75, 9.25), color=(1, 1, 1))
...
surface_max_list = {None: {'feature_grids': 12.2}}
