...
acceptor_projected_point_0 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(28.5), float(4.25), float(65.5), float(0.5)]

cmd.load_cgo(acceptor_projected_point_0, "acceptor_projected_point_0_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_0_score", pos=(28.5, 4.25, 65.5), color=(1, 1, 1), label=33.6)

cmd.pseudoatom(object="acceptor_projected_point_0_proj_score", pos=(30.5, 6.25, 66.25), color=(1, 1, 1), label=6.1)

acceptor_projected_projection_0 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(30.5), float(6.25), float(66.25), float(0.5)]

cmd.load_cgo(acceptor_projected_projection_0, "acceptor_projected_projection_0_obj", 1)
cmd.pseudoatom(object="acceptor_projected_line_0pa1", pos=(28.5, 4.25, 65.5), color=(1, 1, 1))

cmd.pseudoatom(object="acceptor_projected_line_0pa2", pos=(30.5, 6.25, 66.25), color=(1, 1, 1))
...
acceptor_projected_point_1 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(28.5), float(4.25), float(65.5), float(0.5)]

cmd.load_cgo(acceptor_projected_point_1, "acceptor_projected_point_1_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_1_score", pos=(28.5, 4.25, 65.5), color=(1, 1, 1), label=33.6)

cmd.pseudoatom(object="acceptor_projected_point_1_proj_score", pos=(30.0, 2.75, 67.0), color=(1, 1, 1), label=22.9)

acceptor_projected_projection_1 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(30.0), float(2.75), float(67.0), float(0.5)]

cmd.load_cgo(acceptor_projected_projection_1, "acceptor_projected_projection_1_obj", 1)
cmd.pseudoatom(object="acceptor_projected_line_1pa1", pos=(28.5, 4.25, 65.5), color=(1, 1, 1))
...
acceptor_projected_point_2 = [COLOR, 1.0, 0.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(28.5), float(4.25), float(65.5), float(0.5)]

cmd.load_cgo(acceptor_projected_point_2, "acceptor_projected_point_2_obj", 1)
cmd.pseudoatom(object="acceptor_projected_point_2_score", pos=(28.5, 4.25, 65.5), color=(1, 1, 1), label=33.6)

cmd.pseudoatom(object="acceptor_projected_point_2_proj_score", pos=(26.75, 1.25, 65.75), color=(1, 1, 1), label=2.6)

acceptor_projected_projection_2 = [COLOR, 1.0, 0.6, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(26.75), float(1.25), float(65.75), float(0.5)]

cmd.load_cgo(acceptor_projected_projection_2, "acceptor_projected_projection_2_obj", 1)
cmd.pseudoatom(object="acceptor_projected_line_2pa1", pos=(28.5, 4.25, 65.5), color=(1, 1, 1))

cmd.pseudoatom(object="acceptor_projected_line_2pa2", pos=(26.75, 1.25, 65.75), color=(1, 1, 1))
...
ring_planar_projected_point_3 = [COLOR, 0.33, 1.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(27.5), float(4.75), float(64.5), float(0.5)]

cmd.load_cgo(ring_planar_projected_point_3, "ring_planar_projected_point_3_obj", 1)
cmd.pseudoatom(object="ring_planar_projected_point_3_score", pos=(27.5, 4.75, 64.5), color=(1, 1, 1), label=30.2)

cmd.pseudoatom(object="ring_planar_projected_point_3_proj_score", pos=(29.0, 4.25, 62.25), color=(1, 1, 1), label=28.3)

ring_planar_projected_projection_3 = [COLOR, 0.73, 1.0, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(29.0), float(4.25), float(62.25), float(0.5)]

cmd.load_cgo(ring_planar_projected_projection_3, "ring_planar_projected_projection_3_obj", 1)
cmd.pseudoatom(object="ring_planar_projected_line_3pa1", pos=(27.5, 4.75, 64.5), color=(1, 1, 1))

cmd.pseudoatom(object="ring_planar_projected_line_3pa2", pos=(29.0, 4.25, 62.25), color=(1, 1, 1))
...
ring_planar_projected_point_4 = [COLOR, 0.33, 1.0, 0.0] +  [ALPHA, 1.0] + [SPHERE, float(27.5), float(4.75), float(64.5), float(0.5)]

cmd.load_cgo(ring_planar_projected_point_4, "ring_planar_projected_point_4_obj", 1)
cmd.pseudoatom(object="ring_planar_projected_point_4_score", pos=(27.5, 4.75, 64.5), color=(1, 1, 1), label=30.2)

cmd.pseudoatom(object="ring_planar_projected_point_4_proj_score", pos=(25.75, 5.5, 66.75), color=(1, 1, 1), label=29.4)

ring_planar_projected_projection_4 = [COLOR, 0.73, 1.0, 0.6] +  [ALPHA, 1.0] + [SPHERE, float(25.75), float(5.5), float(66.75), float(0.5)]

cmd.load_cgo(ring_planar_projected_projection_4, "ring_planar_projected_projection_4_obj", 1)
cmd.pseudoatom(object="ring_planar_projected_line_4pa1", pos=(27.5, 4.75, 64.5), color=(1, 1, 1))

cmd.pseudoatom(object="ring_planar_projected_line_4pa2", pos=(25.75, 5.5, 66.75), color=(1, 1, 1))
...
cmd.group("acceptor_projected_pts", members="acceptor_projected_0")
...
cmd.group("feature_grids", members="ring_planar_projected")
cmd.group("feature_grids", members="donor_projected")
cmd.group("feature_grids", members="acceptor_projected")
cmd.group("feature_grids", members="surface_ring_planar_projected")
...
surface_list = {None: {'feature_grids': ['surface_ring_planar_projected', 'surface_donor_projected', 'surface_acceptor_projected']}}
surface_max_list = {None: {'feature_grids': 33.6}}
